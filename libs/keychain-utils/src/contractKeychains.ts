...
export const CONTRACT_KEYCHAINS: Record<string, Keychain> = {
  V3_FACTORY: {
    ...
    '0xa': '0xb08Cc8C343cF6dC20d8cf51Fb2D6C436c6390dAa',
  ...
  BAAL_SINGLETON: {
    ...
    '0xa': '0x17234C0Ae25AF09fAf57B9D5ea2B93C1f220E800',
  ...
  GNOSIS_MULTISEND: {
    ...
    // '0xa': '0xA238CBeb142c10Ef7Ad8442C6D1f9E89e07e7761',
  ...
  VAULT_SUMMONER: {
    ...
    '0xa': '0xC39E8D4DE75c6aC025a0C07dCd8Aeb0728C5DBF1',
